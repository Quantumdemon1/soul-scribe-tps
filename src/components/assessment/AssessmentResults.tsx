      ...
      <Card className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent border-primary/20">
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3">
            {showSaveButton && (
              <Button onClick={handleSave} className="flex items-center gap-2 text-sm" size="sm">
                <Save className="w-3 h-3 md:w-4 md:h-4" />
                Save Results
              </Button>
            )}
            <Button variant="outline" onClick={handleDownloadPDF} className="flex items-center gap-2 text-sm" size="sm">
              <Download className="w-3 h-3 md:w-4 md:h-4" />
              Download PDF
            </Button>
            <Button variant="outline" onClick={handleShare} className="flex items-center gap-2 text-sm" size="sm">
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            <div className="text-center p-3 md:p-4 rounded-lg bg-muted/50">
              <div className="text-xs md:text-sm text-muted-foreground mb-1">MBTI Type</div>
              <div className="text-xl md:text-2xl font-bold text-primary">{enhancedProfile.mappings.mbti}</div>
            ...
            <div className="text-center p-3 md:p-4 rounded-lg bg-muted/50">
              <div className="text-xs md:text-sm text-muted-foreground mb-1">Enneagram</div>
            ...
            <div className="text-center p-3 md:p-4 rounded-lg bg-muted/50 sm:col-span-2 md:col-span-1">
              <div className="text-xs md:text-sm text-muted-foreground mb-1">Alignment</div>
              <div className="text-base md:text-lg font-bold text-primary">{enhancedProfile.mappings.dndAlignment}</div>
